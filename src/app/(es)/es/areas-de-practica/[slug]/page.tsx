...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return areaMetadata(LANG, {
    title: `Abogado de ${area.name} en Houston, Texas`,
    description: `${area.short} ${firm.attorney} representa a los lesionados en Texas y Tennessee. Consulta gratis — ${firm.phone}.`,
